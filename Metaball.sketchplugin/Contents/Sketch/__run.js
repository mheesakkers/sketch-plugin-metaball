...
function () {
  function Circle(context) {
    ...
    this.position = new _Vector_js__WEBPACK_IMPORTED_MODULE_1__["default"](0, 0);
    this.radius = 0;
    this.style = {}; // Tangents
  ...
  _createClass(Circle, [{
    ...
    value: function calculateTangents(other) {
      ...
      this.midpoint = new _Vector_js__WEBPACK_IMPORTED_MODULE_1__["default"]((this.position.x + other.position.x) * 0.5, (this.position.y + other.position.y) * 0.5); // ellipse(parent, 'MidpointRadius', this.midpoint, '#F2CFDA', radiusMidpoint * 2)
    ...
    value: function _getHelperPoint(currentRadius, otherRadius, position, direction, positive) {
      ...
      return new _Vector_js__WEBPACK_IMPORTED_MODULE_1__["default"](position.x + currentRadius * Math.cos(angle), position.y + currentRadius * Math.sin(angle));
    } // DRAWING FUNCTIONS
...
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Circle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Circle.js */ "./src/Circle.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  if (!selection.isEmpty) {
    ...
    selection.layers.forEach(function (layer) {
      if (layer.type == 'ShapePath') {
        if (layer.shapeType === 'Oval') {
          ...
          sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("Works only with two Oval layers");
        }
      } else {
        sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("Works only with two Ovals");
      }
    }); // START CALCULATIONS
    ...
    if (ovals.length > 1) {
      ...
      var ovalOne = ovals[0];
      var ovalTwo = ovals[1]; // First Circle

      var circleOne = new _Circle_js__WEBPACK_IMPORTED_MODULE_1__["default"](context);
      ...
      circleOne.style = ovalOne.style; // Second circle

      var circleTwo = new _Circle_js__WEBPACK_IMPORTED_MODULE_1__["default"](context);
      ...
      sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("Try to select at least two ovals.");
    }
  } else {
